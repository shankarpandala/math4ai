...
// Keys = curriculum IDs (subjectId/chapterId/sectionId), values = lazy-loaded components.
const CONTENT_REGISTRY = {
  ...
  '01-foundations/c2-sets-functions/s1-sets': lazy(() => import('../subjects/01-foundations/c2-sets-functions/s1-sets.jsx')),
  '01-foundations/c2-sets-functions/s2-relations': lazy(() => import('../subjects/01-foundations/c2-sets-functions/s2-relations.jsx')),
  '01-foundations/c2-sets-functions/s3-functions': lazy(() => import('../subjects/01-foundations/c2-sets-functions/s3-functions.jsx')),
  ...
  '02-linear-algebra/c6-decompositions/s1-lu': lazy(() => import('../subjects/02-linear-algebra/c6-decompositions/s1-lu.jsx')),
  ...
  '03-calculus/c2-differentiation/s2-mvt': lazy(() => import('../subjects/03-calculus/c2-differentiation/s2-mvt.jsx')),
  '03-calculus/c2-differentiation/s3-taylor': lazy(() => import('../subjects/03-calculus/c2-differentiation/s3-taylor.jsx')),
  '03-calculus/c3-integration/s1-riemann': lazy(() => import('../subjects/03-calculus/c3-integration/s1-riemann.jsx')),
  '03-calculus/c3-integration/s2-ftc': lazy(() => import('../subjects/03-calculus/c3-integration/s2-ftc.jsx')),
  '03-calculus/c3-integration/s3-techniques': lazy(() => import('../subjects/03-calculus/c3-integration/s3-techniques.jsx')),
  '03-calculus/c3-integration/s4-improper': lazy(() => import('../subjects/03-calculus/c3-integration/s4-improper.jsx')),
  '03-calculus/c4-multivariable/s1-partial-derivatives': lazy(() => import('../subjects/03-calculus/c4-multivariable/s1-partial-derivatives.jsx')),
  '03-calculus/c4-multivariable/s2-gradients': lazy(() => import('../subjects/03-calculus/c4-multivariable/s2-gradients.jsx')),
  '03-calculus/c4-multivariable/s3-jacobian': lazy(() => import('../subjects/03-calculus/c4-multivariable/s3-jacobian.jsx')),
  '03-calculus/c4-multivariable/s4-hessian': lazy(() => import('../subjects/03-calculus/c4-multivariable/s4-hessian.jsx')),
  '03-calculus/c4-multivariable/s5-lagrange': lazy(() => import('../subjects/03-calculus/c4-multivariable/s5-lagrange.jsx')),
  '03-calculus/c5-vector-calculus/s1-vector-fields': lazy(() => import('../subjects/03-calculus/c5-vector-calculus/s1-vector-fields.jsx')),
  '03-calculus/c5-vector-calculus/s2-stokes': lazy(() => import('../subjects/03-calculus/c5-vector-calculus/s2-stokes.jsx')),
  ...
  '04-probability/c1-probability-spaces/s2-conditional': lazy(() => import('../subjects/04-probability/c1-probability-spaces/s2-conditional.jsx')),
  ...
  '04-probability/c3-distributions/s2-gaussian': lazy(() => import('../subjects/04-probability/c3-distributions/s2-gaussian.jsx')),
  ...
  '04-probability/c8-concentration/s1-basic-ineq': lazy(() => import('../subjects/04-probability/c8-concentration/s1-basic-ineq.jsx')),
  ...
  '05-statistics/c7-causal-inference/s2-do-calculus': lazy(() => import('../subjects/05-statistics/c7-causal-inference/s2-do-calculus.jsx')),
  ...
  '07-optimization/c2-unconstrained/s2-newton': lazy(() => import('../subjects/07-optimization/c2-unconstrained/s2-newton.jsx')),
