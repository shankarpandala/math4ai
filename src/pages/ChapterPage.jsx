          ...
          {sections.map((section, idx) => {
            ...
            return (
              ...
              >
                <Link
                  to={to}
                  className={`group flex items-start gap-4 rounded-xl border p-4 transition-all hover:shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 ${
                    done
                      ? 'border-emerald-200 bg-emerald-50/50 dark:border-emerald-900/40 dark:bg-emerald-950/20'
                      : 'border-gray-200 bg-white hover:border-indigo-200 hover:bg-indigo-50/30 dark:border-gray-800 dark:bg-gray-900 dark:hover:border-indigo-800/50 dark:hover:bg-indigo-950/10'
                  }`}
                >
