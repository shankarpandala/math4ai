              ...
              {subjectProgress.map(({ subject, completed, total, percent }, idx) => (
                ...
                >
                  <Link
                    ...
                    className="flex items-center gap-3 rounded-xl border border-gray-200 bg-white p-4 hover:shadow-sm transition-shadow dark:border-gray-800 dark:bg-gray-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500"
                  >
                    <span
                  ...
                  {bookmarks.map((bm, idx) => (
                    ...
                    >
                      <Link
                        ...
                        className="flex flex-1 items-start gap-2 text-sm min-w-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 rounded"
                      >
                        <BookmarkIcon />
                      ...
                      <button
                        ...
                        className="shrink-0 rounded p-1 text-gray-400 hover:bg-gray-100 hover:text-red-500 dark:text-gray-500 dark:hover:bg-gray-800 dark:hover:text-red-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500"
