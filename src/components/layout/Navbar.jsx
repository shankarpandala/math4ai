      ...
      <div className="flex h-full items-center justify-between px-4 gap-3">
        ...
        <div className="flex items-center gap-3 shrink-0">
          <button
            ...
            className="lg:hidden rounded-md p-1.5 text-gray-600 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-800 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500"
          ...
          >
            <span
              className="bg-gradient-to-r from-blue-500 to-violet-600 bg-clip-text text-transparent"
              aria-hidden="true"
            >
              ∑
            </span>
